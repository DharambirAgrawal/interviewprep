    ...
    <div className="relative overflow-hidden">
      ...
      <section className="py-20 lg:py-28">
        <SectionTitle
          ...
          // className="mb-16"
        >
          Our cutting-edge AI interview platform provides personalized feedback,
          realistic mock interviews, and comprehensive skill assessment to help
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-blue-50 to-indigo-50/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            jobs using our AI-powered interview preparation platform.
          </SectionTitle>
          <ContactForm />
        </div>
      </section>
